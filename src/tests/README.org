...
*** create-addtag-view-edit-delete
...
| 3.3 Click on the "Flip" button                       | 3.4 The system renders the phrase "I love parenthesis" in the card preview                                                                     |          |
...
| 4.1 Selects "tutorial" from the tag menu             | "tutorial" appears alongside "parenthesis" in the added tags                                                                                   | #4       |
...
| 3.3 Click on the "Flip" button                       | 3.2 The system renders the word "Scheme" in the card preview                                                                                   |          |
